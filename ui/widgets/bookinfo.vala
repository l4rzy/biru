...
namespace Biru.UI.Widgets {
    public class BookInfo : Gtk.Box {
        ...
        public void load_book (Models.Book book) {
            ...
            this.num_fav.set_label ("Favorites: " + book.num_favourites.to_string ());
